...
const AccountSettings = () => {
  ...
  useEffect(() => {
    ...
    const fetchAvailability = async (token) => {
      try {
        const res = await fetch("https://api.get-a-developer.buttnetworks.com/api/profilestatus", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
    ...
    const fetchUserMessages = async (userId, token) => {
      try {
        const res = await fetch(`https://api.get-a-developer.buttnetworks.com/api/user-messages/${userId}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const updateAvailability = async (newStatus) => {
    try {
      ...
      if (res.ok) {
        ...
        const createRes = await fetch("https://api.get-a-developer.buttnetworks.com/api/profilestatus", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const confirmAction = async () => {
    ...
    try {
      if (modal === "logout") {
        await fetch("https://api.get-a-developer.buttnetworks.com/api/auth/logout", {
          method: "POST",
      ...
      if (modal === "delete") {
        await fetch("https://api.get-a-developer.buttnetworks.com/api/auth/delete", {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        });
