                ...
                {currentStep === 6 && (
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-gray-500 text-sm mb-4">Link to your complete portfolio or website</p>
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm mb-4">Direct link to your profile picture</p>
